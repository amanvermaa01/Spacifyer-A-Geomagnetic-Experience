  ...
  return (
    <>
      <div className="w-full h-screen bg-black ">
        ...
        <button
          onClick={handleHome}
          className="text-xl text-white font-bold mt-6 font-mono absolute top-0 right-0 m-4"
        >
          Home
        </button>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="w-full">
                              <input
                                ...
                                id="form3Example1c"
                                name="name"
                                className="form-control w-full px-4 py-2 border text-black border-gray-300 rounded-lg focus:ring focus:ring-indigo-500 focus:border-indigo-500 font-sans"
                                value={formData.name}
