    ...
    <>
      <div className="h-full w-full relative p-[5vw_2.8vw]">
        ...
        <div className="overflow-hidden elem">
          <h1 className="about-space-weather animate-on-scroll text-[2vw] text-white font-thin">
          ...
          <h2 className="about-space-weather-2 animate-on-scroll text-[2.5vw] text-white font-thin">
          ...
          <div className="flex items-center">
            <a
              className="text-white font-[rejoy] font-bold text-[5vw] m-20 underline"
              href="https://en.wikipedia.org/wiki/Space_weather"
            >
              Click here to learn more
            </a>
            <img
              className="ml-auto mr-10 p-10 rounded-xl float-right w-1/2"
